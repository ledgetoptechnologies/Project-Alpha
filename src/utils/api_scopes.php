...
function api_scope_catalog(): array
{
    return [
        ...
        'directory.units.read' => ['label'=>'API v2 unit directory read','description'=>'Read externally managed customer departments (units).','endpoints'=>[]],
        'directory.units.binding_status.read' => ['label'=>'API v2 unit binding status','description'=>'Check one application-scoped unit binding.','endpoints'=>[]],
        'directory.units.bind' => ['label'=>'API v2 unit identity binding','description'=>'Bind an existing unit to one external identity.','endpoints'=>[]],
        'directory.units.binding.revision.refresh' => ['label'=>'API v2 unit binding revision refresh','description'=>'Advance one unit binding to its verified live revision.','endpoints'=>[]],
        'directory.units.write' => ['label'=>'API v2 unit directory write','description'=>'Update the API-owned unit profile.','endpoints'=>[]],
        'directory.units.create' => ['label'=>'API v2 unit directory create','description'=>'Create and bind a unit beneath an organization.','endpoints'=>[]],
        'directory.units.organization.assign' => ['label'=>'API v2 unit organization assignment','description'=>'Create a unit beneath an exact active organization binding.','endpoints'=>[]],
        'directory.units.archive' => ['label'=>'API v2 unit archive','description'=>'Soft-archive a unit while retaining PA project history.','endpoints'=>[]],
        'directory.units.restore' => ['label'=>'API v2 unit restore','description'=>'Restore a unit without reviving external bindings.','endpoints'=>[]],
        'directory.units.contacts.assign' => ['label'=>'API v2 unit contact assignment','description'=>'Assign an active same-organization client to a unit.','endpoints'=>[]],
        'directory.units.contacts.remove' => ['label'=>'API v2 unit contact removal','description'=>'Remove an exact unit contact assignment.','endpoints'=>[]],
        'directory.units.contacts.set_primary' => ['label'=>'API v2 unit primary contact','description'=>'Set the single primary contact for a unit.','endpoints'=>[]],
        'directory.units.unbind' => ['label'=>'API v2 unit binding revocation','description'=>'Revoke one application-scoped unit binding.','endpoints'=>[]],
