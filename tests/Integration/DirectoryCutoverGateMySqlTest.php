...
final class DirectoryCutoverGateMySqlTest extends TestCase
{
    ...
    {
        self::assertTrue(\api_v2_directory_management_schema_ready($this->first), 'Disposable cutover schema must match the current activation contract.');
...
PHP
    ...
    {
        $tables = [
            'api_v2_directory_management_audit', 'api_v2_directory_management_attestations', 'api_v2_directory_management_policy',
            'api_v2_directory_backfill_attestations', 'api_v2_directory_unit_contact_command_receipts',
            'api_v2_directory_unit_profile_command_receipts', 'api_v2_directory_lifecycle_command_receipts',
            'api_v2_directory_relationship_command_receipts', 'api_v2_directory_binding_revoke_command_receipts',
            'api_v2_directory_create_command_receipts', 'api_v2_directory_client_profile_command_receipts',
            'api_v2_directory_organization_profile_command_receipts', 'api_v2_directory_binding_revision_refresh_receipts',
            'api_v2_directory_binding_command_receipts', 'api_v2_directory_resource_changes', 'api_v2_directory_resource_state',
            'organization_department_contacts', 'organization_departments', 'api_v2_directory_authorization_state',
            'api_keys', 'api_v2_applications', 'api_v2_history_identity', 'clients', 'organizations', 'app_config', 'schema_migrations',
        ];
        ...
        $this->first->exec(<<<'SQL'
CREATE TABLE schema_migrations(version INT PRIMARY KEY,filename VARCHAR(255));
CREATE TABLE app_config(organization_id INT NOT NULL,config_key VARCHAR(191) NOT NULL,config_value TEXT,PRIMARY KEY(organization_id,config_key));
CREATE TABLE api_v2_applications(id BIGINT UNSIGNED PRIMARY KEY,application_id CHAR(36),name VARCHAR(191));
CREATE TABLE api_keys(id BIGINT UNSIGNED PRIMARY KEY,api_v2_application_id BIGINT UNSIGNED,scopes LONGTEXT,revoked_at DATETIME NULL);
CREATE TABLE api_v2_history_identity(singleton TINYINT PRIMARY KEY,source_instance_id CHAR(36),history_epoch CHAR(36));
CREATE TABLE api_v2_directory_authorization_state(application_pk BIGINT UNSIGNED PRIMARY KEY,authorization_generation BIGINT UNSIGNED);
CREATE TABLE clients(id INT PRIMARY KEY,public_id CHAR(32),name VARCHAR(150),email VARCHAR(255),phone VARCHAR(50),client_type VARCHAR(20),organization_id INT NULL,address_line1 VARCHAR(255),address_line2 VARCHAR(255),city VARCHAR(100),state VARCHAR(16),postal_code VARCHAR(32),country VARCHAR(100),archived TINYINT DEFAULT 0,deleted_at DATETIME NULL);
CREATE TABLE organizations(id INT PRIMARY KEY,public_id CHAR(32),name VARCHAR(150),general_email VARCHAR(255),general_phone VARCHAR(50),address_line1 VARCHAR(255),address_line2 VARCHAR(255),city VARCHAR(100),state VARCHAR(16),postal_code VARCHAR(32),country VARCHAR(100),archived TINYINT DEFAULT 0,deleted_at DATETIME NULL);
CREATE TABLE organization_departments(id INT PRIMARY KEY,public_id CHAR(32),organization_id INT,name VARCHAR(150),archived TINYINT DEFAULT 0,deleted_at DATETIME(6) NULL);
CREATE TABLE organization_department_contacts(department_id INT,client_id INT,role VARCHAR(100),is_primary TINYINT DEFAULT 0,primary_department_id INT GENERATED ALWAYS AS (IF(is_primary=1,department_id,NULL)) VIRTUAL,UNIQUE KEY uq_organization_department_primary(primary_department_id));
CREATE TABLE api_v2_directory_resource_state(resource_type VARCHAR(32),public_id CHAR(32),revision BIGINT UNSIGNED,projection_sha256 CHAR(64),present TINYINT,PRIMARY KEY(resource_type,public_id));
CREATE TABLE api_v2_directory_resource_changes(resource_type VARCHAR(32),public_id CHAR(32),revision BIGINT UNSIGNED,action VARCHAR(16),PRIMARY KEY(resource_type,public_id,revision));
CREATE TABLE api_v2_directory_backfill_attestations(attestation_sha256 CHAR(64) PRIMARY KEY,attestation_json LONGTEXT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_management_policy(singleton TINYINT PRIMARY KEY,configured_enabled TINYINT,ownership_active TINYINT,application_pk BIGINT UNSIGNED NULL,source_instance_id CHAR(36) NULL,application_id CHAR(36) NULL,history_epoch CHAR(36) NULL,release_attestation_sha256 CHAR(64) NULL,last_effective TINYINT,last_reason VARCHAR(64),configured_by INT NULL,configured_at DATETIME NULL,updated_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_management_attestations(attestation_sha256 CHAR(64) PRIMARY KEY,attestation_json LONGTEXT,created_by INT NULL,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_management_audit(id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,event_type VARCHAR(64),outcome VARCHAR(32),reason VARCHAR(64),application_pk BIGINT UNSIGNED NULL,actor_user_id INT NULL,target_type VARCHAR(32) NULL,action_name VARCHAR(96) NULL,metadata_json LONGTEXT NULL,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_binding_command_receipts(application_pk BIGINT,resource_type VARCHAR(32),history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),external_id VARBINARY(764),public_id CHAR(32),resource_revision BIGINT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_binding_revision_refresh_receipts(application_pk BIGINT,resource_type VARCHAR(32),history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),external_id VARBINARY(764),public_id CHAR(32),expected_prior_revision BIGINT,result_revision BIGINT,result_projection_sha256 CHAR(64),expected_authorization_generation BIGINT,result_authorization_generation BIGINT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_organization_profile_command_receipts(application_pk BIGINT,history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),public_id CHAR(32),expected_revision BIGINT,expected_authorization_generation BIGINT,result_revision BIGINT,result_projection_sha256 CHAR(64),created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_client_profile_command_receipts(application_pk BIGINT,history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),public_id CHAR(32),expected_revision BIGINT,expected_authorization_generation BIGINT,result_revision BIGINT,result_projection_sha256 CHAR(64),created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_create_command_receipts(application_pk BIGINT,resource_type VARCHAR(32),history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),external_id VARBINARY(764),public_id CHAR(32),expected_authorization_generation BIGINT,result_revision BIGINT,result_projection_sha256 CHAR(64),result_authorization_generation BIGINT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_lifecycle_command_receipts(application_pk BIGINT,resource_type VARCHAR(32),history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),action_name VARCHAR(32),public_id CHAR(32),expected_revision BIGINT,expected_authorization_generation BIGINT,result_revision BIGINT,result_authorization_generation BIGINT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_relationship_command_receipts(application_pk BIGINT,history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),action_name VARCHAR(32),client_public_id CHAR(32),expected_client_revision BIGINT,expected_authorization_generation BIGINT,result_client_revision BIGINT,result_authorization_generation BIGINT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_binding_revoke_command_receipts(application_pk BIGINT,resource_type VARCHAR(32),history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),external_id VARBINARY(764),public_id CHAR(32),expected_resource_revision BIGINT,expected_authorization_generation BIGINT,result_authorization_generation BIGINT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_unit_profile_command_receipts(application_pk BIGINT,history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),public_id CHAR(32),expected_revision BIGINT,expected_authorization_generation BIGINT,result_revision BIGINT,result_projection_sha256 CHAR(64),result_authorization_generation BIGINT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
CREATE TABLE api_v2_directory_unit_contact_command_receipts(application_pk BIGINT,history_epoch CHAR(36),command_id CHAR(36),request_sha256 CHAR(64),action_name VARCHAR(32),unit_public_id CHAR(32),client_public_id CHAR(32),expected_unit_revision BIGINT,expected_authorization_generation BIGINT,result_unit_revision BIGINT,result_projection_sha256 CHAR(64),result_authorization_generation BIGINT,created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6));
INSERT INTO app_config VALUES(0,'api_v2_directory_management_ownership_active','0');
INSERT INTO api_v2_applications VALUES(3,'223e4567-e89b-42d3-a456-426614174000','disposable acceptance application');
...
INSERT INTO api_v2_directory_management_policy(singleton,configured_enabled,ownership_active,last_effective,last_reason) VALUES(1,0,0,0,'not_configured');
SQL);
        foreach ([88,89,90,91,92,93,94,95,96,97,98,99,103,104,105,106] as $version) {
            $matches = glob(dirname(__DIR__, 2) . '/database/migrations/' . str_pad((string)$version, 4, '0', STR_PAD_LEFT) . '_*.sql');
            self::assertCount(1, $matches);
            $this->first->prepare('INSERT INTO schema_migrations(version,filename) VALUES(?,?)')->execute([$version, basename($matches[0])]);
        }
    }
}
