...
final class DirectoryCutoverGateTest extends TestCase
{
    ...
    public function testAllCanonicalCommandKindsAcquireAnExplicitSharedGate(): void
    {
        ...
        self::assertStringContainsString('api_v2_directory_management_acquire_shared_gate($pdo);', (string) file_get_contents($root . '/src/utils/api_v2_directory_backfill.php'));
    }
}
