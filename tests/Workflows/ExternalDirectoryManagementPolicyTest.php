...
final class ExternalDirectoryManagementPolicyTest extends TestCase
{
    ...
    public function testLiveFlagKeyRevocationScopeSiblingAndAttestationChecksAreIndependent(): void
    {
        ...
        try{
            ...
            $json=json_encode(['version'=>1,'schemaVersion'=>99,'writerDigest'=>$writerDigest,'backfillDigest'=>str_repeat('a',64)],JSON_THROW_ON_ERROR|JSON_UNESCAPED_SLASHES);$digest=hash('sha256',$json);
    ...
    public function testAuthorizedStatelessApiCommandsRemainOutsideTheBrowserGuard(): void
    {
        ...
        foreach(['directory_create_command_v2.php','directory_client_profile_command_v2.php','directory_organization_profile_command_v2.php','directory_binding_command_v2.php','directory_binding_revision_refresh_v2.php','directory_lifecycle_command_v2.php','directory_relationship_command_v2.php','directory_binding_revoke_command_v2.php','directory_inventory_v2.php'] as $controller){
