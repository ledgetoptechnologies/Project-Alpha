...
final class ExternalDirectoryManagementPolicyTest extends TestCase
{
    ...
    public function testLiveFlagKeyRevocationScopeSiblingAndAttestationChecksAreIndependent(): void
    {
        ...
        try{
            ...
            $json=json_encode(['version'=>1,'schemaVersion'=>106,'writerDigest'=>$writerDigest,'backfillDigest'=>str_repeat('a',64)],JSON_THROW_ON_ERROR|JSON_UNESCAPED_SLASHES);$digest=hash('sha256',$json);
    ...
    public function testActivationAttestationRequiresCurrentBackfillReceipt(): void
    {
        ...
        $json = json_encode(['version'=>1,'schemaVersion'=>106,'writerDigest'=>api_v2_directory_management_code_digest(),'backfillDigest'=>$backfillDigest], JSON_THROW_ON_ERROR|JSON_UNESCAPED_SLASHES);
    ...
    public function testMigrationIsRegisteredWithoutChangingEarlierHealthSnapshots(): void
    {
        ...
        $profileEpochColumns=['api_v2_directory_organization_profile_command_receipts'=>['history_epoch'],'api_v2_directory_client_profile_command_receipts'=>['history_epoch']];
        self::assertSame([],migration_required_columns_for_version($profileEpochColumns,105));
        self::assertSame($profileEpochColumns,migration_required_columns_for_version($profileEpochColumns,106));
