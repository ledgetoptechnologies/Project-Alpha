...
final class ProcessorImportManagedDirectoryTest extends TestCase
{
    ...
    private function clientDatabase(): PDO
    {
        ...
        $pdo->exec(
            ...
            CREATE TABLE organization_departments(id INTEGER PRIMARY KEY, organization_id INTEGER, public_id TEXT, name TEXT, notes TEXT, archived INTEGER DEFAULT 0, deleted_at TEXT);
