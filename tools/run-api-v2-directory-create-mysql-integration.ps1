...
try {
    ...
    $env:API_V2_DIRECTORY_CREATE_MYSQL_DSN="mysql:host=127.0.0.1;port=$databasePort;dbname=$databaseName;charset=utf8mb4"
    $env:API_V2_DIRECTORY_CREATE_MYSQL_USER=$databaseUser; $env:API_V2_DIRECTORY_CREATE_MYSQL_PASSWORD=$databasePassword; $env:API_V2_DIRECTORY_CREATE_MYSQL_DATABASE=$databaseName; $env:API_V2_DIRECTORY_CREATE_MYSQL_ALLOW_DESTRUCTIVE='isolated-disposable-only'
